...
const todoColumn = document.querySelector('section > div > div:nth-child(1)');
const inProgressColumn = document.querySelector('section > div > div:nth-child(2)');
const completedColumn = document.querySelector('section > div > div:nth-child(3)');
function openModal() {
...
function renderColumn(columnEl, title, columnTasks, iconClass, iconBgClass, iconColorClass, statusKey) {
...
taskForm.addEventListener('submit', (e) => {
    ...
    addTask(titleInput.value.trim(), prioritySelect.value, dueDateInput.value, descriptionInput.value.trim());
    closeModal();
});
renderBoard();
